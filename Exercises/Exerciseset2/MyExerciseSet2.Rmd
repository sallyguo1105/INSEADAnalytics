...
**Your Answers here:**
<br>1. 6
<br>2. 0.93 (5yr T notes US and 10yr T notes)
<br>3. Component 1:govenment bonds
<br>   Component 2:Currencies and Commodities
<br>   Component 3:European Stock Market
<br>   Component 4:US Stock Market
<br>   Component 5:European Bonds and Rates
<br>   Component 6:Oil & Gas
<br>   Component 7:Metals
<br>   Component 8:Agriculture product
<br>   Component 9:Precious Metals
<br>   Component 10:Asian Stock Market
<br>4. 
<br>a) pre-crisis years
<br>
```{r echo=FALSE, comment=NA, warning=FALSE, message=FALSE, results='asis'}
...
colnames(df) <- c("eigenvalues", "components", "abline")
Line_precrisis <- gvisLineChart(as.data.frame(df), xvar="components", yvar=c("eigenvalues","abline"), options=list(title='Scree plot', legend="right", width=900, height=600, hAxis="{title:'Number of Components', titleTextStyle:{color:'black'}}", vAxes="[{title:'Eigenvalues'}]",  series="[{color:'green',pointSize:3, targetAxisIndex: 0}]"))
...
colnames(df) <- c("eigenvalues", "components", "abline")
Line_crisis <- gvisLineChart(as.data.frame(df), xvar="components", yvar=c("eigenvalues","abline"), options=list(title='Scree plot', legend="right", width=900, height=600, hAxis="{title:'Number of Components', titleTextStyle:{color:'black'}}", vAxes="[{title:'Eigenvalues'}]",  series="[{color:'green',pointSize:3, targetAxisIndex: 0}]"))
...
```
<br>
<br>5. The financial products are more correlated during crisis years; the market can be better explained with fewer factors.
<hr>
...
**Your Answers here:**
<br>1. The code collects the moving average signals and make investment decisions based on the signs.
<br>2. By changing the code to MAfreq<-seq(10,250,by=20), we will get a return of Ret:5.7, Vol:7.7, Sharpe:0.74, DD: 21.9 
