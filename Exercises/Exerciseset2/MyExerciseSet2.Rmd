...
**Your Answers here:**
1. 6
2. 0.93 (5yr T notes US and 10yr T notes)
3. Component 1:govenment bonds
   Component 2:Currencies and Commodities
   Component 3:European Stock Market
   Component 4:US Stock Market
   Component 5:European Bonds and Rates
   Component 6:Oil & Gas
   Component 7:Metals
   Component 8:Agriculture product
   Component 9:Precious Metals
   Component 10:Asian Stock Market
4. 
a) pre-crisis years
...
print(m1,'chart')
```
5. The financial products are more correlated during crisis years; the market can be better explained with fewer factors.
<hr>
...
**Your Answers here:**
1. The code collects the moving average signals and make investment decisions based on the signs.
2. By changing the code to MAfreq<-seq(10,250,by=20), we will get a return of Ret:5.7, Vol:7.7, Sharpe:0.74, DD: 21.9 
